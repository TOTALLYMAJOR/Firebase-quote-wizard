...
| 13 | Global event context across surfaces | Implemented | `src/context/EventTypeContext.jsx`, `src/context/OrganizationContext.jsx`, `src/main.jsx`, `src/App.jsx`, `src/components/AdminCatalogModal.jsx` |
...
- Multi-tenant org scoping is live in additive mode; temporary legacy fallback remains configurable for migration safety.
